...
class SectorForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {'name': forms.TextInput(attrs = {'placeholder':'eg. El Capitan'}),
                    'region': forms.TextInput(attrs = {'placeholder': 'eg. Yosemite, USA'})}
...
class RouteForm(forms.ModelForm):
    class Meta:
        ...
        widgets = { 'route_type': forms.RadioSelect(),
                    ...
                    'name': forms.TextInput(attrs={"placeholder": "eg. The Nose"})}
