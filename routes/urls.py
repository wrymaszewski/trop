...
urlpatterns = [
    ...
    name = 'route_list'),
    url(r'^(?P<sector_slug>[-\w]+)/(?P<route_slug>[-\w]+)/ascents/$', views.RouteAscentList.as_view(),
    name = 'route_ascents'),
    url(r'^(?P<username>\w+)/ascents/$', views.UserAscentList.as_view(),
    name = 'user_ascents'),
    url(r'^ascent/new/$', views.CreateAscent.as_view(),
    name = 'new_ascent'),
    url(r'^(?P<sector_slug>[-\w]+)/(?P<route_slug>[-\w]+)/ascent/new/$', views.CreateAscentFromRoute.as_view(),
