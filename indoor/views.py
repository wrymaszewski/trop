...
class CreateTraining(LoginRequiredMixin, CreateView):
    ...
    def form_valid(self, form):
        ...
        self.object.save()
        self.success_url = reverse_lazy('indoor:new_top',
...
class CreateTop(LoginRequiredMixin, CreateView):
    ...
    def get_initial(self):
        return {
            'training': models.Training.objects.get(pk=self.kwargs.get('pk'))
            }

    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['training'] = (models.Training
                               .objects
                               .get(pk=self.kwargs.get('pk')))
        return context
...
class UpdateTop(LoginRequiredMixin, UpdateView):
    ...
    def form_valid(self, form):
        self.object = self.get_object()
        self.success_url = reverse_lazy('indoor:top_list',
                                        kwargs={'pk': self.object.training.pk})
        self.object.save()
        return super().form_valid(form)
...
class DeleteTraining(LoginRequiredMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        self.object = self.get_object()
        success_url = reverse_lazy('indoor:training_list',
                                   kwargs={
                                     'username': self.object.user.username})
        self.object.delete()
...
class DeleteTop(LoginRequiredMixin, DeleteView):
    ...
    def delete(self, request, *args, **kwargs):
        self.object = self.get_object()
        success_url = reverse_lazy('indoor:top_list',
                                   kwargs={'pk': self.object.training.pk})
        self.object.delete()
        return HttpResponseRedirect(success_url)
